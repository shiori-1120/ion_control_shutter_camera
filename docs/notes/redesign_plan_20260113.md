...
---
## 進捗メモ
- 2026-01-13: GUIをSetup/Run/Diagnosticsに再構成し、Manual/Camera/Sweep/Sequenceの導線を整理。
- 2026-01-13: GUIログパネル/Diagnosticsの機能を整備（最後のエラー表示、履歴、フィルタ、コピー）。
- 2026-01-13: Sequence JSONを唯一の入力元にし、Sequence/Sweep側は参照表示へ統一。
- 2026-01-13: device_registryの骨格を追加し、起動/終了時の読み書きを配線。
- 2026-01-13: hardware/pipelineのディレクトリ骨格とAdapter(DAQ/Camera/FG)を追加。
- 2026-01-14: SweepのEvents/IO/Deps境界とPhase状態機械を導入。
- 2026-01-14: SweepのROI/Threshold/Spectrumをworkflowへ寄せ、GUI依存を低減。
- 2026-01-14: output_root/logs_rootの解決を統一し、実行出力先を共通化。
- 2026-01-14: Sequence JSONのcamera_actions/sync_markersを検証・保持し、sweepに引き回し。
- 2026-01-14: sweepのconfig.jsonにupdate_interval/camera_actions/sync_markersを保存。
